const Testimonial = ({ name, title, subtitle, border, text }) => {
        ...
        <>
            <div className={`flex items-center w-[70%] gap-4 font-barlow`}>
                ...
                <div className="flex flex-col">
                    <span className={`text-${text} text-[13px] font-[600]`} >{name}</span>
                    <p className={`text-${text} text-[13px] opacity-50 font-[500]`} >Verified Graduate</p>
                </div>
            </div>
            <div className="font-barlow mt-[1rem] flex flex-col gap-4
            justify-evenly">
                <span className={`font-[600] text-${text} text-xl`} >
                    {title}
                </span>
                <span className={`font-[500] text-${text} text-[13px] opacity-70`} >
                    "{subtitle}"
                </span>
            </div>
        </>
...
const Grid = () => {
    return (
        <div className="flex align-middle justify-evenly" >
            <div className="md:grid md:grid-cols-4 gap-4 w-[90%]">
                <div className="bg-moderate-violet col-span-2 flex flex-col p-5 rounded-xl">
                    <Testimonial
                        name="Daniel Clifford" border="light-violet" text="light-gray"
                ...
                <div className="bg-very-dark-grayish-blue flex-col p-5 rounded-xl">
                    <Testimonial
                        name="Jonathan Walters" text="light-gray"
                ...
                <div className="bg-white row-span-2 flex-col p-5 rounded-xl">
                    <Testimonial 
                    name="Kira Whittle" text="very-dark-blackish-blue"
                ...
                <div className="bg-very-dark-blackish-blue col-span-2 p-5 rounded-xl">
                    <Testimonial
                        name="Patrick Abrams" border="moderate-violet" text="light-gray"
